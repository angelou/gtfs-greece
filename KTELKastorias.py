...
url = "http://www.ktel-kastorias.gr/?module=default&pages_id=18&lang=el"
driver.get(url)
...
schedule.AddAgency(agency_id = "KTELKastorias",
                   name = "Urban and Suburban Transportations of Kastoria Perfecture",
                   timezone = "Europe/Athens",
                   url = "http://www.ktel-kastorias.gr")

# Retrieve route links
route_links = driver.find_elements_by_xpath("//div[@id='subMenu']/ul/li/a")
...
for url in route_urls:
    ...
    # Retrieve the number of directions listed
    directions = driver.find_elements_by_xpath("//div[@class='content']/h2")
    ...
    for direction_index, direction in enumerate(directions):
        ...
        trips = driver.find_elements_by_xpath("//div[@class='content']/table[@class='route-table'][%s]/tbody/tr" % (direction_index + 1))
